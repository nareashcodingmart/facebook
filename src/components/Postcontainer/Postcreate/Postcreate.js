  ...
  return (
    <div className='postcreatecontainer'>
       <div className='postcreatecontainertop'>
        ...
        <div className='postcreateline' onClick={()=>setPostopen(1)}> What's on your mind, {profile.first_name}?</div>
       </div>
       ...
       <div className='postcreatecontainerbottom'>
        ...
        <div onClick={()=>setPostopen(1)}><img src="https://static.xx.fbcdn.net/rsrc.php/v3/y7/r/Ivw7nhRtXyo.png" alt=""/> Photo/video</div>
        <div onClick={()=>{setPostfeel(1);setPostopen(1)}}><img src="https://static.xx.fbcdn.net/rsrc.php/v3/yd/r/Y4mYLVOhTwq.png" alt=""/>Feeling/activity</div>
       </div>
