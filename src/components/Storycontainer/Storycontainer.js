  ...
  return (
    <div className='storycontainer'>
      <div className='storycontainertitle'>
        <div onClick={()=>{setStorytitle(1)}} id={storytitle===1?"storycontainertitleactive":""}>
          <span className={storytitle===1?"storycontainertitlehoveroff":'storycontainertitlehover'}>
        ...
        <div onClick={()=>{setStorytitle(0)}} id={storytitle===0?"storycontainertitleactive":""}>
          <span className={storytitle===0?"storycontainertitlehoveroff":'storycontainertitlehover'}>
