    ...
    <div className='postcomponent'key={props.value} >
      <div className='posttitle'>
        ...
        <div className='posttitleidname'>
          <div className='posttitleidnamefirst '>
            <h4 className='clusor underlinehover'>Behindwoods</h4>
        ...
        <div className='posttitlebuttonsecond clusor displayflexcenter' onClick={()=>{alert("hi")}}>
          <i></i>
        </div>
      ...
      <div className='postemotion'>
        <div className='postemotionleft' id="gray">
          ...
          {
            reactionview.value!==0 && reactionview.value!=="Like" && <img src={reactionview.img} alt=""/>
          }
          <div className='postemotionleftspan underlinehover'>
          {
            reactionview.value!==0?<span> You and 69 others</span>:<span>69</span>
          }
          </div>
        </div>
