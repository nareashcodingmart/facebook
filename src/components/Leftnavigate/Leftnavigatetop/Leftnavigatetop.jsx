...
import "./Leftnavigatetop.css"
const Leftnavigatetop = (props) => {
    return (
        <div className='leftnavigatetop'>
            <div className='leftnavigatetopheader'>
                <h1>{props.name}</h1>
                <div className='leftnavigatetopsetting'><i /></div>
            </div>
            {
                props.input?
            (<div className='leftnavigatetopsearch'>
                <label>
                ...
                <input type='search' placeholder={`Search ${props.search}`}/>
            </div>):<></>
}
        </div>
    )
...
export default Leftnavigatetop
